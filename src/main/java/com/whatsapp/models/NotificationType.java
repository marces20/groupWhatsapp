...
public class NotificationType implements Serializable {
  ...
  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "notification_types_seq_gen")
  @SequenceGenerator(name = "notification_types_seq_gen", sequenceName = "notification_types_id_seq", allocationSize = 1)
  private Integer id;
